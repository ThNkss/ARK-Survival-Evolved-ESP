...
public:
	...
	// and opens a handle
	Memory(std::wstring processName) noexcept
	{
	...
	std::uintptr_t GetModuleAddress(std::wstring moduleName) const noexcept
	{
		::MODULEENTRY32 entry = { };
	...
	// Finds dynamic memory address 
	uintptr_t FindDMAAddy(uintptr_t base, std::vector<uintptr_t>offsets)
	{
		auto ptr = base;
